...
public class PractoTest extends BaseTest {
    ...
    public void testHospitalSearch() throws InterruptedException, IOException {
        ExtentReport.createTest("Hospital Search Test");
        ...
        try{
            ...
            ExtentReport.logInfo("Hospitals found: " + hospitals.size());
            ...
            com.selenium.utility.ExcelWriter writer = new com.selenium.utility.ExcelWriter(System.getProperty("user.dir") + "/src/test/resources/testdata/TestData.xlsx");
            ...
            ExtentReport.logPass("Hospital search test passed");
            logger.info("testHospitalSearch completed successfully.");
        }catch (Exception e){
            ExtentReport.logFail("Hospital search test failed: " + e.getMessage());
            throw e;
        }
    }
    ...
    public void testTopCities() throws IOException {
        ExtentReport.createTest("Top Cities Test");
        ...
        try{
            ...
            ExtentReport.logInfo("Top Cities: " + cities);
            ...
            ExtentReport.logPass("Top cities test passed");
            logger.info("testTopCities completed successfully.");
        } catch (Exception e) {
            ExtentReport.logFail("Top cities test failed: " + e.getMessage());
            throw e;
        }
    }
    ...
    public void testCorporateForm_InvalidData_FromExcel() throws InterruptedException, java.io.IOException {
        ExtentReport.createTest("Corporate Wellness Form Test");
        ...
        try {
            ...
            for (int r = 1; r < totalRows; r++) {
                ...
                ExtentReport.logInfo("Submit Button Enabled: " + enabled);
            ...
            if (enabled) {
                ExtentReport.logFail("Corporate form test failed");
            } else {
                ExtentReport.logPass("Corporate form submit button not enabled");
            }
            ...
            ExtentReport.logFail("Corporate form test failed: " + e.getMessage());
            throw e;
        }
